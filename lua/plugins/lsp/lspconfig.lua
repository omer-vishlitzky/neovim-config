  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        vim.keymap.set('n', 'gd', require('telescope.builtin').lsp_definitions, { buffer = event.buf, desc = '[G]oto [D]efition'})
        ...
        vim.keymap.set('n', '<leader>td', require('telescope.builtin').lsp_type_definitions, { buffer = event.buf, desc = 'Type [D]efinition'})
